...
frappe.ui.form.on('Pengajuan Uang Jasa dan Sisa Gaji Karyawan', {
	refresh: function(frm) {
		//cur_frm.cscript.custom_validate = function(doc) {
		frappe.ui.form.on("Pengajuan Uang Jasa dan Sisa Gaji Karyawan","sisa_kewajiban",function(frm, doctype, name){
		...
		frappe.ui.form.on("Pengajuan Uang Jasa dan Sisa Gaji Karyawan","quit_date",function(){
